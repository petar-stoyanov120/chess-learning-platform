              ...
              <>
                {user ? (
                  <div className="flex items-center gap-4">
                    ...
                    <Link
                      href={user.role === 'admin' ? '/admin' : user.role === 'club_admin' ? '/club-admin' : '/dashboard'}
          ...
          <div className="md:hidden pb-4 space-y-2">
            ...
            {user ? (
              <>
                ...
                <Link href={user.role === 'admin' ? '/admin' : user.role === 'club_admin' ? '/club-admin' : '/dashboard'} className="block px-2 py-2 hover:text-chess-cream" onClick={() => setMenuOpen(false)}>Dashboard</Link>
