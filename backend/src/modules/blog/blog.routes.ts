...
router.get('/my/:id', authenticate, authorize('collaborator', 'admin', 'club_admin'), controller.getMyPost);

// Dynamic slug route (must be last of the GETs)
router.get('/:slug', controller.getBySlug);

router.post('/', authenticate, authorize('collaborator', 'admin', 'club_admin'), controller.createPost);
router.patch('/:id', authenticate, authorize('collaborator', 'admin', 'club_admin'), controller.updatePost);
router.delete('/:id', authenticate, authorize('admin'), controller.deletePost);

router.patch('/:id/submit', authenticate, authorize('collaborator', 'admin', 'club_admin'), controller.submitPost);
